...
const mywork_data = [
  ...
  },
  {
    ...
    w_img2: event2,
    w_detail:
      "Tech Stack: MERN (MongoDB, Express.js, React.js, Node.js), WebSocket (Socket.io), JWT Authentication, Tailwind CSS",
    w_detail2:
    "Built a secure, full-stack chat application supporting real-time one-to-one and group messaging using WebSocket. Implemented user authentication with JWT, live online/offline status indicators, and message delivery/read receipts. Added group chat management features, ensuring seamless communication with an intuitive and responsive UI."  ,
    w_title: "03.  ChatApplication – A real-time messaging platform",
    w_link: "https://talk-a-tive-7fgq.onrender.com/",
  },
];
